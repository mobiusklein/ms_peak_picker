...
static char __pyx_k_stop_index[] = "stop_index";
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "ms_peak_picker._c.search")) {
      if (unlikely(PyDict_SetItemString(modules, "ms_peak_picker._c.search", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("nearest_right", (void (*)(void))__pyx_f_14ms_peak_picker_2_c_6search_nearest_right, "size_t (PyArrayObject *, __pyx_t_14ms_peak_picker_2_c_6search_DTYPE_t, int __pyx_skip_dispatch, struct __pyx_opt_args_14ms_peak_picker_2_c_6search_nearest_right *__pyx_optional_args)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (__Pyx_ExportFunction("get_nearest", (void (*)(void))__pyx_f_14ms_peak_picker_2_c_6search_get_nearest, "size_t (PyArrayObject *, __pyx_t_14ms_peak_picker_2_c_6search_DTYPE_t, size_t, int __pyx_skip_dispatch)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  /*--- Type import code ---*/
