from ._c.peak_set import FittedPeak as FittedPeak
from .utils import Base as Base, ppm_error as ppm_error, range as range
...
class PeakSet(Base):
    ...
    def __init__(self, peaks: Iterable) -> None: ...
    def __len__(self): ...
